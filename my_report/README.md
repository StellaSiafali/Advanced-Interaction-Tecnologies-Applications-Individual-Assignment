...
#### Στο παραπάνω μάθημα γενικότερα,γίνεται μία εισαγωγή θεμάτων σχεδιασμού, ανάπτυξης, εφαρμογής και αξιολόγησης advanced user interfaces και natural user interfaces, NUIs. Στο εργαστήριο συγκεκριμένα κάναμε μία εισαγωγή στο Processing. Ένα απλό προγραμματιστικό περιβάλλον που δημιουργήθηκε για να διευκολύνει την ανάπτυξη οπτικά προσανατολισμένων εφαρμογών με έμφαση στην κίνηση και την άμεση ανατροφοδότηση των χρηστών μέσω της αλληλεπίδρασης. Οι προγραμματιστές ήθελαν ένα μέσο για να "σκιτσάρουν" ιδέες σε κώδικα. Έπειτα ασχολέιται και με την κάμερα Kinect, μία κάμερα που σχετίζεται και παράγει κίνηση.

# Summary

#### Για την κατανόηση κυρίως της εφαρμογής των διαφόρων αλληλεπιδράσεων το εργαστηριακό μάθημα είχε 3 παραδοτέα. Μέσα από αυτά στόχος είναι η επαφή με τα παραπάνω θέματα.  Για την ολοκλήρωση των παραδοτέων χρηάστηκε η μελέτη των εξής γλωσσών προγραμματισμού: Processing με την βιβλιοθήκη (SimpleOpenNI library) και C#. Μέσα από τα παραδείγματα που υπήρχαν στις οδηγίες επιτυνχάθηκε η εξάσκηση του κώδικα και η κατανόηση των γλωσσών.
...
#### Για την εκτέλεση του 3ου και τελευταίου παραδοτέου εργάστηκα ως εξής: διάβασα τις οδηγίες προσεκτικά τις κατανόησα και συνέχισα στην υλοποίηση του. Κατέβασα αρχικά τις βιβλιοθήκες, τις εφαρμογές και την Java Runtime Enviroment μέσω των λινγκ από τις οδηγίες.  Άνοιξα το παράδειγμα TUIO στο processing ,αφού είχα μεταφέρει το αρχείο αυτό (tuio) από τον φάκελο tuio processing στον φάκελο libraries του processing, το οποίο έτρεξα και επεξεργάστηκα τον κώδικα με σκοπό να κατανοήσω πως λειτουργεί δίνοντας εντολές στα κουτάκια της java enviroment.Από το κεφάλαιο 15-3 του βιβλίου του Shiffman, Daniel - Learning Processing, Second Edition, βοηθήθηκα αρκετά στο κομμάτι των εντολών. Πρόσθεσα στον κώδικα μου μία εικόνα που μου άρεσε, η οποία αναλόγως τα κουτάκια που θα επιλέγω θα αλλάζει σύμφωνα με τον κώδικα που έχω ορίσει. 

Στον κώδικα όρισα τα εξής:

το 1ο-0 κουτάκι (μπλέ) θα εμφανίζει την εικόνα μου, σε περίπτωση που το μπλέ κουτάκι δεν βρίσκεται στον κύκλο κανένα από τα άλλα κουτάκι δεν θα λειτουργεί, διότι τα άλλα κουτάκια εμπεριέχουν εντολές που μορφοποιούν την εικόνα. 

το 2ο-1 κουτάκι (κόκκινο) κάνει zoom in - out την εικόνα μου

το 3ο-2 κουτάκι (κίτρινο) κάνει rotate, περιστρέφει την εικόνα μου

το 4ο-3 κουτάκι (πράσινο) σκοτεινιάζει την εικόνα μου

και το 5ο-4 κυκλάκι (μπλε) αλλάζει σε μωβ-ροζ αποχρώσεις την εικόνα μου.

### ***1ο-0 ΜΠΛΕ κουτάκι - Εμφάνιση εικόνας :blue_heart:***
|                                        |                                        |                                         |
|:-----------------------------------------:|:----------------------------------------------------:|:-------------------------------:|
|![Screenshot (36)](https://user-images.githubusercontent.com/100956284/212438846-dabfe169-a081-423d-a4b5-ae9751a141c2.png)|

### ***2ο-1 ΚΟΚΚΙΝΟ κουτάκι - Zoom in - out εικόνα :heart:***
|                                        |                                        |                                         |
|:-----------------------------------------:|:----------------------------------------------------:|:-------------------------------:|
|![Screenshot (39)](https://user-images.githubusercontent.com/100956284/212438948-672ce16b-e356-46f8-881a-9268fc820914.png)|![Screenshot (40)](https://user-images.githubusercontent.com/100956284/212439121-322d6125-be00-4d1b-bdea-e331afe1d2f6.png)|![Screenshot (38)](https://user-images.githubusercontent.com/100956284/212439318-03a54d5d-2bc9-47ff-8e8b-4b670f2e3ffb.png)|

### ***3ο-2 ΚΙΤΡΙΝΟ κουτάκι - Περιστροφή εικόνας :yellow_heart:***
|                                        |                                        |                                         |
|:-----------------------------------------:|:----------------------------------------------------:|:-------------------------------:|
|![Screenshot (41)](https://user-images.githubusercontent.com/100956284/212439417-4ebda73b-f42a-4c31-b59a-19c1f0c609b4.png)|![Screenshot (42)](https://user-images.githubusercontent.com/100956284/212439421-245d88f6-61ec-4f92-ba8d-3c40f80f6d85.png)|![Screenshot (43)](https://user-images.githubusercontent.com/100956284/212439424-87f797db-c122-4185-b5b8-e5cebb976e32.png)|

### ***4ο-3 ΠΡΑΣΙΝΟ κουτάκι - Σκοτείνιασμα εικόνας :green_heart:***
|                                        |                                        |                                         |
|:-----------------------------------------:|:----------------------------------------------------:|:-------------------------------:|
|![Screenshot (44)](https://user-images.githubusercontent.com/100956284/212439433-0e5e32fb-4137-4e1f-bfad-18b8dbf9d3c9.png)|

### ***5ο-4 ΜΠΛΕ κυκλάκι - Αλλαγή απόχρωσης εικόνας (μωβ-ροζ τόνους) :large_blue_circle:***
|                                        |                                        |                                         |
|:-----------------------------------------:|:----------------------------------------------------:|:-------------------------------:|
|![Screenshot (45)](https://user-images.githubusercontent.com/100956284/212439437-27675d2a-9869-4237-809d-9abcf4e76e46.png)|![Screenshot (46)](https://user-images.githubusercontent.com/100956284/212439444-eb96193f-7a29-42c6-9a58-4ed9cf9b34e6.png)|
...
### :grey_question:Ερώτηση:grey_question:: 
 ...
 ### :pencil2:Απάντηση:pencil2:: 
 #### Έχοντας επιλέξει την κανονική κάμερα η διαδικάσία πραγματοποιείται πιο αργά, είναι χρονοβόρα, σε αντίθεση με τον προσομοιωτή όπου η διαδικάσία είναι ευκολότερη και γρηγορότερη. Ο προσωμοιωτής εμπεριέχει έτοιμο κώδικα, αναπαρίστα και τα fiducials έτσι ο χρήστης είναι ικανός να τον προσαρμώσει ανάλογα με αυτό που θέλει να δημιουργήσει. Παρόλα αυτά πιο αποτελεσματική φαίνεται να είναι η χρήση της κανονικής κάμερας.

# Bonus 

# Conclusions

#### Έχοντας ολοκληρώσει και τα 3 παραδοτέα τα συμπεράσματα μου είναι ότι το Processing διαθέτει μία αρκετά μεγάλη γκάμα παραδειγμάτων το οποίο με βοήθησε πολύ στο να μελετήσω και να κατανοήσω των κώδικα. Σχετικά με την υλοποίηση των παραδοτέων έχω να επισημάνω πως το 1ο και το 3ο ήταν αρκετά δύσκολα, σπατάλησα αρκετό χρόνο για να τα ολοκληρώσω, ένω το 2ο μου φάνηκε πιο βατό. Παρόλα αυτά θεωρώ πως το μάθημα είναι πολύ ενδιαφέρον και μέσω των παραπάνω παραδοτέων μας δώθηκε η δυνατότητα να αλληλεπίδρασουμε με τον υπολογιστή και τις απίστευτες ικανότητες της διαδραστικής σχεδίασης.

# Sources
Αναφέρονται στην παραπάνω αναφορά.
