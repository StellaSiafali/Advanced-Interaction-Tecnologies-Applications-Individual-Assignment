...
#### Για την εκτέλεση του 3ου και τελευταίου παραδοτέου εργάστηκα ως εξής: διάβασα τις οδηγίες προσεκτικά τις κατανόησα και συνέχισα στην υλοποίηση του. Κατέβασα αρχικά τις βιβλιοθήκες, τις εφαρμογές και την Java Runtime Enviroment μέσω των λινγκ από τις οδηγίες.  Άνοιξα το παράδειγμα TUIO στο processing ,αφού είχα μεταφέρει το αρχείο αυτό (tuio) από τον φάκελο tuio processing στον φάκελο libraries του processing, το οποίο έτρεξα και επεξεργάστηκα τον κώδικα με σκοπό να κατανοήσω πως λειτουργεί δίνοντας εντολές στα κουτάκια της java enviroment. 
Από το κεφάλαιο 15-3 του βιβλίου του Shiffman, Daniel - Learning Processing, Second Edition, βοηθήθηκα αρκετά στο κομμάτι των εντολών. Πρόσθεσα στον κώδικα μου μία εικόνα που μου άρεσε, η οποία αναλόγως τα κουτάκια που θα επιλέγω θα αλλάζει σύμφωνα με τον κώδικα που έχω ορίσει. Στον κώδικα όρισα τα εξής: 
το 1ο-0 κουτάκι (μπλέ) θα εμφανίζει την εικόνα μου, σε περίπτβ=ωση που το μπλέ κουτάκι δεν βρίσκεται στον κύκλο κανένα από τα άλλα κουτάκι δεν θα λειτουργεί, διότι τα άλλα κουτάκια εμπεριέχουν εντολές που μορφοποιούν την εικόνα. 
...
## ***1ο-0 ΜΠΛΕ κουτάκι - Εμφάνιση εικόνας***


## ***2ο-1 ΚΟΚΚΙΝΟ κουτάκι - Zoom in - out εικόνα***

## ***3ο-2 ΚΙΤΡΙΝΟ κουτάκι - Περιστροφή εικόνας***

## ***4ο-3 ΠΡΑΣΙΝΟ κουτάκι - Σκοτείνιασμα εικόνας***

## ***5ο-4 ΜΠΛΕ κυκλάκι - Αλλαγή απόχρωσης εικόνας (μωβ-ροζ τόνους)***
